...
namespace UnityStandardAssets._2D {
	public class PlatformerCharacter2D : MonoBehaviour {
		[SerializeField] private readonly float m_MaxSpeed = 10f;                    // The fastest the player can travel in the x axis.
		[SerializeField] private readonly float m_JumpForce = 400f;                  // Amount of force added when the player jumps.
